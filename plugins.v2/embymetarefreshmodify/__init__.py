...
class EmbyMetaRefreshModify(_PluginBase):
    # 插件名称
    plugin_name = "Emby元数据刷新修改版"
    # 插件描述
    ...
    plugin_version = "1.0"
    # 插件作者
    plugin_author = "thsrite,lchecho"
    # 作者主页
    author_url = "https://github.com/thsrite"
    # 插件配置项ID前缀
    plugin_config_prefix = "embymetarefreshmodify_"
    # 加载顺序
    plugin_order = 15
    # 可使用的用户级别
    auth_level = 1
                ...
                for item in latest:
                    ...
                    if refresh_meta == "true" or refresh_image == "true":
                        ...
                        if str(item.get('Type')) == 'Episode':
                            series_items[item.get('SeriesId')] = item.get('SeriesName')
